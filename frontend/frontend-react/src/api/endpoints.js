...
//auth: đăng ký, đăng nhập, logout, refresh token, getMe
...
// jobs: CRUD công việc, toggle featured
...
//applications: nộp CV, xem ứng viên theo job, cập nhật trạng thái, đánh dấu nổi bật, trigger AI chấm điểm lại
