    ...
    const sidebarContent = (
        <>
            ...
            <div className="flex-1 overflow-y-auto py-6 px-4 space-y-1">
                <div className="text-xs font-bold text-text-muted uppercase tracking-wider mb-4 px-2">Menu tuyển dụng</div>
                {navItems.map((item) => {
            ...
            <div className="p-4 border-t border-border space-y-2">
                {/* Khu vực thông tin người dùng / Công ty */}
                <div className="flex items-center gap-3 px-2 mb-4">
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        <div className="text-xs text-text-muted truncate font-medium">{user?.companyName || 'Công ty'}</div>
                    </div>
                </div>
